...
import styles from './CounterSimplified.module.scss';
...
export default function CounterSimplified(props) {
              ...
              {(!!funds || !!balance) && (
                  <React.Fragment>
                    ...
                    <div className={styles.buttons}>
                      <Button.Outline onClick={() => increase(1)} size="small" mainColor="salmon" borderColor="salmon">
                        {sending ? <Loader className={styles.loader} color="white"  /> : <span> Increase Counter by 1</span>}
                      </Button.Outline>
                      <Button.Outline onClick={() => decrease(1)} disabled={!(methods && methods.decreaseCounter)} size="small" mainColor="salmon" borderColor="salmon">
